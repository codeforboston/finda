  ...
  var describeComponentFactory = function (componentPath, specDefinitions) {
    return function () {
      beforeEach(function () {
        ...
        var requireCallback = function (flight, Component) {
          flight.registry.reset();
          this.Component = Component;
        }.bind(this);

        require(['flight', componentPath], requireCallback);
      ...
      afterEach(function () {
        ...
        var requireCallback = function (flight) {
          if (this.component) {
            this.component = null;
          }
  ...
  var describeMixinFactory = function (mixinPath, specDefinitions) {
    return function () {
      beforeEach(function () {
        ...
        var requireCallback = function (flight, Mixin) {
          flight.registry.reset();
          this.Component = flight.component(function () {}, Mixin);
        }.bind(this);

        require(['flight', mixinPath], requireCallback);
